...
abstract class _$$FailureCopyWith<T, $Res> {
  ...
  $DataExceptionCopyWith<$Res> get dataException;
}
...
class __$$FailureCopyWithImpl<T, $Res>
  ...
  $Res call({
    ...
    return _then(_$Failure<T>(
      dataException: null == dataException
  ...
  @pragma('vm:prefer-inline')
  $DataExceptionCopyWith<$Res> get dataException {
    return $DataExceptionCopyWith<$Res>(_value.dataException, (value) {
      return _then(_value.copyWith(dataException: value));
    });
  }
}
...
class _$Failure<T> implements Failure<T> {
  const _$Failure({required this.dataException});
  ...
  @override
  String toString() {
    return 'ApiResult<$T>.failure(dataException: $dataException)';
  }
...
abstract class Failure<T> implements ApiResult<T> {
  const factory Failure({required final DataException dataException}) =
      _$Failure<T>;
